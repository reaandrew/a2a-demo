"""
Security Agent - A2A Server (Hub-and-Spoke Pattern)
...
class SecurityAgentExecutor(AgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        print(f"\n🛡️  SECURITY AGENT received task from orchestrator")
...
def create_security_agent_card(port: int = 10003) -> AgentCard:
    ...
    return AgentCard(
        name="Security Agent",
        description="Scans content for secrets, credentials, API keys, and sensitive data leaks using GitGuardian API.",
